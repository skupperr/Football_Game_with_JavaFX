...
import com.example.opteam.KeyHandler;
...
public class Football extends entity {
    ...
    private OpPlayer controlledPlayer;
...
//        setDefaultValues(gp.tileSize * 21,gp.tileSize * 16);
        getFootballImage();
    }
...
//            System.out.println("Updated Football Position: " + this.worldX + ", " + this.worldY);
    ...
    public int update(OpPlayer player) {
...
//
//            }
            // ** Add fallback to prevent unexpected resets **
...
//    }
    public void kick(OpPlayer player, boolean upArrow) {
...
//        System.out.println("fDraw client: " + worldX + ", " + worldY);
...
//        double offsetY = (gp.tileSize - footballHeight) / 2;
        ...
        double renderX = worldX - gp.football.worldX + gp.football.screenX + offsetX;
        double renderY = worldY - gp.football.worldY + gp.football.screenY + offsetY;
//        double offsetX = 0;
//        double offsetY = 0;
//        gc.drawImage(up1, screenX + offsetX, screenY + offsetY, footballWidth, footballHeight);
        gc.drawImage(up1, renderX, renderY, footballWidth, footballHeight);
